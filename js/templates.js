...
<div class="overlay" onclick="closeDialog('boardAddTaskDialog', 'overlay-placeholder')">
  <div onclick="stopEventBubbling(event)" id="boardAddTaskDialog" class="overlay-content dialog hidden">
      ...
      <form class="form-add-task" action="board.html" id="task-form">
        ...
        <div class="form-submit">
          ...
          <div class="clear-create-button-container">
            <button class="clear-button" type="button" onclick="closeDialog('boardAddTaskDialog', 'overlay-placeholder')">
